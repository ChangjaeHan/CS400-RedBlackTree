...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
     ...
     *  - and see if it makes exception if two parameters are not parent-child relationship
     */
    public static boolean test3() {
    	...
    	LR_tree.rotate(LR_tree.root.leftChild.leftChild, LR_tree.root.leftChild);
    	System.out.println(LR_tree.toLevelOrderString());
    	String expectedOutput = "[ 50, 10, 70, 5, 30, 60, 80, 20, 40, 75, 95 ]";
    	...
    	LR_tree.rotate(LR_tree.root.rightChild.rightChild, LR_tree.root.rightChild);
    	System.out.println(LR_tree.toLevelOrderString());
    	String expectedOutput2 = "[ 50, 10, 80, 5, 30, 70, 95, 20, 40, 60, 75 ]";
    ...
    public static boolean test4() {
    	...
    	//rotate left and right; it may make exception if tree is unbalanced
    	//but it will be solved after RedBlackTree has its own property (self-balanced)
     ...
     * test3: both rotations in the subtree of complex tree & make exception
